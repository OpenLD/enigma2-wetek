...
#			print "using cached result"
	...
	def has_hdmi(self):
		return getBrandOEM() in ('formuler3', 'formuler1', 'xtrend', 'gigablue', 'dags', 'ixuss', 'odin', 'vuplus', 'ini', 'ebox', 'ceryon') or (getBoxType() in ('wetekplay', 'dm7020hd', 'dm800se', 'dm500hd', 'dm8000') and HardwareInfo.device_version is not None)
